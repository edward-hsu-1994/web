"""Static site content served by the API routes.

Each constant is the exact JSON payload returned by its endpoint, built once at
import time instead of being reconstructed on every request.
"""
